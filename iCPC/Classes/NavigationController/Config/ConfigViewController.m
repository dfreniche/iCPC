...
- (void)toggleFling:(id)sender {
    [ICPCConfig sharedInstance].useFling = !([ICPCConfig sharedInstance].useFling);
}


- (void)toggleICade:(id)sender {
    [ICPCConfig sharedInstance].useIcade = !([ICPCConfig sharedInstance].useIcade);
}


- (void)toggleExternalKeyboard:(id)sender {
    [ICPCConfig sharedInstance].useExternalKeyboard = !([ICPCConfig sharedInstance].useExternalKeyboard);
}
